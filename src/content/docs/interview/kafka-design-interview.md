...
Trong các buổi phỏng vấn thiết kế hệ thống (System Design) dành cho vị trí Data Engineer hoặc Backend Engineer cấp độ Mid/Senior, các câu hỏi xoay quanh [Apache Kafka](/concepts/5-stream-processing-realtime/apache-kafka) luôn là một phần cực kỳ quan trọng và hóc búa. 
...
* **[Consumer Groups](/concepts/5-stream-processing-realtime/consumer-groups)**: Cơ chế giúp phân bổ công việc đọc dữ liệu từ một Topic cho nhiều Consumer mà không lo bị trùng lặp dữ liệu. Mỗi Partition chỉ được đọc bởi tối đa một Consumer tại một thời điểm trong cùng một Group.
