...
* **Gợi ý**: Hãy kể về một lần bạn đề xuất cải tiến công nghệ (ví dụ: áp dụng [dbt](/concepts/3-integration/transformation-analytics/dbt/) để quản lý code SQL) nhưng quản lý ban đầu e ngại vì sợ tốn thời gian chuyển đổi. Bạn không cãi vã. Thay vào đó, bạn chủ động dành thời gian làm một bản PoC nhỏ để chạy thử nghiệm thực tế trên một module nhỏ, đo đạc cụ thể thời gian tiết kiệm được và trình bày lại bằng số liệu trực quan để thuyết phục sếp đồng ý.
