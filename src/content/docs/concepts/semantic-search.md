...
* **Số hóa ý nghĩa**: Thông qua các mô hình học máy (Embedding Models), văn bản, hình ảnh hay câu hỏi đều được chuyển đổi thành một chuỗi số thực gọi là Vectơ. Vectơ này biểu diễn vị trí của từ/câu đó trong một không gian đa chiều (thường từ vài trăm đến hàng ngàn chiều).
...
| **Phù hợp** | Tìm kiếm log, mã sản phẩm | Hệ thống RAG, FAQ, gợi ý nội dung |

## Các khái niệm liên quan

* [Vectơ nhúng (Embeddings)](/concepts/embeddings): Nền tảng toán học biểu diễn ngôn ngữ.
* [Phân tách văn bản (Chunking)](/concepts/chunking): Kỹ thuật xử lý văn bản đầu vào.
* [Vector Database](/concepts/vector-database): Cơ sở dữ liệu lưu trữ vectơ chuyên dụng.
