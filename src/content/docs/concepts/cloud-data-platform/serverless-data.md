...
Trước khi có Serverless, việc thiết lập một [Data Pipeline](/concepts/foundation/data-pipeline/) (như cài cụm Hadoop hoặc thuê máy chủ ảo AWS EC2) giống như việc bạn phải bỏ tiền mua một chiếc xe buýt riêng chỉ để đi làm hàng ngày:
...
* **Gánh nặng vận hành (Operational Overhead)**: Thay vì tập trung viết logic xử lý dữ liệu ([ETL](/concepts/etl-elt/etl/)/[ELT](/concepts/etl-elt/elt/)), các Data Engineer phải dành tới một nửa thời gian làm công việc của quản trị hệ thống: vá lỗi bảo mật hệ điều hành, nâng cấp ổ cứng, sửa lỗi mạng, hoặc thay thế các ổ đĩa bị hỏng.
...
* [Google BigQuery](/concepts/cloud-data-platform/google-bigquery/): Kho dữ liệu Serverless hiệu năng cao của Google.
* [Cloud Object Storage](/concepts/cloud-data-platform/cloud-storage/): Dịch vụ lưu trữ đối tượng trên mây.
