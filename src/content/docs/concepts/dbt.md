...
1. **[dbt Models - Tầng biến đổi và cấu trúc dự án](/concepts/dbt-models)** - Tìm hiểu sâu về kiến trúc phân tầng models.
2. **[Kiểm thử tự động - dbt Testing](/concepts/dbt-testing)** - Hướng dẫn chi tiết về các cơ chế test dữ liệu trong dbt.
