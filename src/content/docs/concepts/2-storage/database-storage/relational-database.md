...
definition: "Cơ sở dữ liệu quan hệ (RDBMS) là hệ thống quản trị dữ liệu dựa trên mô hình quan hệ, tổ chức thông tin dưới dạng các bảng liên kết qua khóa chính/khóa ngoại và đảm bảo tính toàn vẹn qua các thuộc tính ACID."
---
...
![Sơ đồ kiến trúc minh họa cho Relational Database](/images/relational-database/rdbms-internals.png)
...
* Yêu cầu lưu trữ khối lượng dữ liệu khổng lồ (hàng Petabytes) phục vụ cho việc phân tích dữ liệu lớn hoặc huấn luyện Machine Learning (nên chọn [Data Lake](/concepts/2-storage/data-lake-lakehouse/data-lake/)).

## Các khái niệm liên quan

* [OLTP](/concepts/2-storage/database-storage/oltp/)
* [Indexing](/concepts/2-storage/database-storage/indexing/)
...
2. [AWS Relational Database Service (RDS)](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Welcome.html) - AWS documentation detailing relational database administration and architectures.
3. [Google Cloud SQL Overview](https://cloud.google.com/sql/docs) - GCP documentation on managed relational database services for MySQL, PostgreSQL, and SQL Server.
4. [Azure SQL Database Architectural Overview](https://learn.microsoft.com/en-us/azure/azure-sql/database/sql-database-paas-overview) - Microsoft guide on Azure SQL Database features, scaling, and high-availability patterns.
5. [Apache Derby Project Overview](https://db.apache.org/derby/) - Apache DB project detailing Java-based relational database architectures.
6. [Database System Concepts](https://db-book.com/db-content/slides/) - Textbook by Abraham Silberschatz, Henry F. Korth, and S. Sudarshan covering relational theory, transactions, and SQL.
7. [PostgreSQL Official Documentation](https://www.postgresql.org/docs/) - Official reference manual for PostgreSQL RDBMS.
