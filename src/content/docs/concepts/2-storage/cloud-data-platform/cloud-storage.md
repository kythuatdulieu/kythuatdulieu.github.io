...
definition: "Cloud Object Storage là dịch vụ lưu trữ đối tượng phẳng trên đám mây (như AWS S3, Azure Blob, GCS), cung cấp khả năng mở rộng vô hạn, độ bền cao và chi phí cực thấp."
seoTitle: "Cloud Object Storage là gì? Tìm hiểu Amazon S3 và Azure Blob"
metaDescription: "Khám phá Cloud Object Storage (lưu trữ đối tượng trên đám mây): định nghĩa, kiến trúc, so sánh với File/Block Storage và cách xây dựng Data Lake."
---

Trong kỷ nguyên của Big Data và Điện toán đám mây, việc tìm kiếm một nơi lưu trữ dữ liệu vừa rẻ, vừa an toàn, lại có khả năng mở rộng vô hạn là mong muốn của mọi doanh nghiệp. **Cloud Object Storage (Lưu trữ đối tượng trên đám mây)** chính là lời giải hoàn hảo cho bài toán đó. Từ những cái tên quen thuộc như Amazon S3, Google Cloud Storage (GCS) cho đến Azure Blob Storage, công nghệ này đã trở thành xương sống vững chắc cho các kiến trúc Data Lake và Data [Lakehouse](/concepts/2-storage/data-lake-lakehouse/lakehouse/) hiện đại ngày nay.
...
* **Không nên dùng khi:**
  * Cần lưu trữ cho các ứng dụng giao dịch yêu cầu cập nhật từng mili-giây (như cơ sở dữ liệu giỏ hàng, hệ thống [OLTP](/concepts/2-storage/database-storage/oltp/)).
...
* Định dạng dữ liệu cột Parquet ([Columnar Storage](/concepts/2-storage/database-storage/columnar-storage/))
* [Kiến trúc Serverless Data](/concepts/2-storage/cloud-data-platform/serverless-data/)
