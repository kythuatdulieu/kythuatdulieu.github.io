...
# Spark Partition (Phân vùng trong Spark)
...
* [Shuffle](/concepts/shuffle): Cơ chế xáo trộn dữ liệu vật lý.
* [Data Skew](/concepts/data-skew): Hiện tượng lệch phân bố dữ liệu giữa các phân vùng.
* [Spark Execution Model](/concepts/spark-execution-model): Mô hình thực thi tính toán phân tán của Spark.
...
2. Blog kỹ thuật Databricks về Tối ưu hóa kích thước khối dữ liệu và AQE.
