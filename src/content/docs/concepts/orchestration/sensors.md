...
* [Apache Airflow](/concepts/orchestration/apache-airflow/): Nền tảng điều phối dữ liệu mã nguồn mở.
* [Orchestration](/concepts/orchestration/orchestration/): Quy trình tự động hóa các luồng công việc.
* [Task Dependency](/concepts/orchestration/task-dependency/): Thiết lập sự phụ thuộc giữa các tác vụ.
