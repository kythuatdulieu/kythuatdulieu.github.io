...
* [Spark Execution Model](/concepts/spark-execution-model): Mô hình phân bổ tài nguyên Master-Slave.
* [Shuffle](/concepts/shuffle): Cơ chế xáo trộn dữ liệu qua mạng lưới.
* [Spark Partition](/concepts/spark-partition): Các phân mảnh dữ liệu vật lý.

## Góc phỏng vấn: Chinh phục cấu trúc thực thi của Spark
