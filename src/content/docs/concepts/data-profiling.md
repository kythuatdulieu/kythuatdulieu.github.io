...
1. **[Data Quality Dimensions](/concepts/data-quality-dimensions)** - Hiểu về các khía cạnh đánh giá chất lượng dữ liệu.
2. **[Data Catalog](/concepts/data-catalog)** - Nơi lưu trữ thông tin metadata thu được từ quá trình Profiling.
