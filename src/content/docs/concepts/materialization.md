...
1. [dbt Models (Mô hình dbt)](/concepts/dbt-models) - Quản lý các tầng biến đổi dữ liệu.
2. [dbt Testing (Kiểm thử dbt)](/concepts/dbt-testing) - Tích hợp kiểm thử chất lượng dữ liệu.
3. [Data Warehouse (Kho dữ liệu)](/concepts/data-warehouse) - Hệ thống lưu trữ dữ liệu phân tích tập trung.
