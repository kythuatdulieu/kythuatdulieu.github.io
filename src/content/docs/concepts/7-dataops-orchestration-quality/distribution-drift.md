...
description: "Hãy tưởng tượng bạn đang vận hành một đường ống dữ liệu ([data pipeline](/concepts/1-distributed-systems-architecture/data-pipeline)) rất mượt mà. Schema của các bảng không hề bị thay đổi, khối lượng dữ liệu (data volume) vẫn nằm trong ngưỡng dự đoán. Thế nhưng, độ chính xác của các mô hình Machine Learning (ML) sử dụng dữ liệu này lại bất ngờ lao dốc, hoặc các báo cáo BI bắt đầu đưa ra những con số vô lý. Nguyên nhân sâu xa thường nằm ở một kẻ thù thầm lặng: **Trôi dạt phân phối (Distribution Drift)** hay còn gọi phổ biến là **Data Drift**."
---



Hãy tưởng tượng bạn đang vận hành một đường ống dữ liệu ([data pipeline](/concepts/1-distributed-systems-architecture/data-pipeline)) rất mượt mà. Schema của các bảng không hề bị thay đổi, khối lượng dữ liệu (data volume) vẫn nằm trong ngưỡng dự đoán. Thế nhưng, độ chính xác của các mô hình Machine Learning (ML) sử dụng dữ liệu này lại bất ngờ lao dốc, hoặc các báo cáo BI bắt đầu đưa ra những con số vô lý. Nguyên nhân sâu xa thường nằm ở một kẻ thù thầm lặng: **Trôi dạt phân phối (Distribution Drift)** hay còn gọi phổ biến là **Data Drift**.
