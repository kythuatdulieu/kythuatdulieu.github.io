...
* [Trôi dạt cấu trúc - Schema Drift](/concepts/observability-reliability/schema-drift/)
* [Khả năng quan sát dữ liệu - Data Observability](/concepts/observability-reliability/data-observability/)
...
2. **Machine Learning Engineering in Action** - Ben Wilson.
3. **A Primer on Population Stability Index (PSI)**.
