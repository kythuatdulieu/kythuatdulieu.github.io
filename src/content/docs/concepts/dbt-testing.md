...
1. **[Data Quality](/concepts/data-quality)** - Hiểu về triết lý quản trị chất lượng dữ liệu.
2. **[dbt Models - Tầng biến đổi và cấu trúc dự án](/concepts/dbt-models)** - Cách phân tầng thư mục dbt khoa học.
