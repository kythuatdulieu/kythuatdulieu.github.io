...
* [Data Skew](/concepts/batch-processing/data-skew/): Hiện tượng lệch phân phối dữ liệu trong các phân vùng.
* [Spark Partitions](/concepts/batch-processing/spark-partition/): Các phân mảnh dữ liệu của Spark.
* [Spark Joins](/concepts/batch-processing/spark-joins/): Các kỹ thuật nối bảng dữ liệu.
