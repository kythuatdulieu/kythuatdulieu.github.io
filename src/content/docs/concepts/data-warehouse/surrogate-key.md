...
2. Surrogate Keys Keep Control - Ralph Kimball's article on the essential role of surrogate keys in the Kimball Group archives.
3. Generating surrogate keys with dbt - Best practices on utilizing cryptographic hashes to construct surrogate keys in dbt Developer Blog.
