...
3. [Generating surrogate keys with dbt](https://docs.getdbt.com/blog/generating-surrogate-keys-with-dbt) - Best practices on utilizing cryptographic hashes to construct surrogate keys in dbt Developer Blog.
