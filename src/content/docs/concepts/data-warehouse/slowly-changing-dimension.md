...
* **Nếu chúng ta làm như database nguồn ([OLTP](/concepts/database-storage/oltp/))**: Chỉ đơn giản chạy lệnh `UPDATE` cập nhật khu vực của John thành "TP.HCM".
...
1. [The Data Warehouse Toolkit, 3rd Edition](https://www.oreilly.com/library/view/the-data-warehouse/9781118530801/) - Ralph Kimball's definitive guide to [dimensional modeling](/concepts/data-warehouse/dimensional-modeling/) and SCD patterns on O'Reilly.
...
4. [Slowly Changing Dimensions in Snowflake with dbt](https://docs.getdbt.com/docs/build/snapshots) - [Snowflake](/concepts/cloud-data-platform/snowflake/) blog post outlining design patterns for tracking historical dimension changes.
