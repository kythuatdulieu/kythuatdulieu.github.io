...
Để trả lời những câu hỏi đó, Databricks đã cho ra đời **Unity Catalog** – giải pháp quản trị dữ liệu ([Data Governance](/concepts/governance-metadata/data-governance/)) và tài sản AI tập trung, đóng vai trò như một "người gác đền" thông minh và tin cậy cho cấu trúc Data [Lakehouse](/concepts/data-lake-lakehouse/lakehouse/).

## Unity Catalog là gì? Tấm khiên quản trị dữ liệu tập trung

Về mặt kiến trúc, **Unity Catalog** là một lớp quản trị (Governance Layer) thống nhất nằm ngay phía trên kho lưu trữ đám mây (như AWS S3, Azure ADLS, hay Google [Cloud Storage](/concepts/cloud-data-platform/cloud-storage/)). 
...
2. [Introducing Unity Catalog: Fine-grained Governance for Data and AI on the Lakehouse](https://www.databricks.com/blog/2021/05/26/introducing-unity-catalog-fine-grained-governance-for-data-and-ai-on-the-lakehouse.html) - Databricks blog announcement detailing Unity Catalog's architecture and capabilities.
