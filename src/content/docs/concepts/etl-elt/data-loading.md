...
* [Idempotency (Tính lũy đẳng)](/concepts/etl-elt/idempotency/) - Cơ chế đảm bảo tính nhất quán của dữ liệu khi chạy lại pipeline.
* [ETL (Extract - Transform - Load)](/concepts/etl-elt/etl/) - Quy trình trích xuất, biến đổi và nạp dữ liệu kinh điển.
* [Data Pipeline (Đường ống dữ liệu)](/concepts/foundation/data-pipeline/) - Hệ thống tự động hóa di chuyển dữ liệu từ nguồn đến đích.
