...
4. [Databricks Documentation: MERGE INTO](https://docs.databricks.com/en/sql/language-manual/sql-ref-syntax-dml-merge-into.html) - Technical reference on using MERGE INTO in Delta Lake for transactional upserts and deletes.
5. [AWS Architecture Center: Data Ingestion and Loading best practices](https://docs.aws.amazon.com/redshift/latest/dg/t_Loading-data-from-s3.html) - AWS guide on optimized bulk data loading into Amazon Redshift using the COPY command.
