...
* **Hạn chế đối với dữ liệu thời gian thực (Streaming)**: SQL trên Data Warehouse hoạt động hiệu quả nhất ở dạng Batch (theo lô). Đối với các bài toán yêu cầu xử lý luồng dữ liệu thời gian thực với độ trễ cực thấp dưới 1 giây, các framework như Apache Flink hoặc [Apache Spark](/concepts/batch-processing/apache-spark/) Streaming vẫn là những lựa chọn tối ưu hơn.
