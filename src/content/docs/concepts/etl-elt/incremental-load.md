...
* [Trích xuất dữ liệu (Data Extraction)](/concepts/etl-elt/data-extraction/)
* [Change Data Capture (CDC - Ghi nhận sự thay đổi dữ liệu)](/concepts/etl-elt/change-data-capture/)
* [ELT (Extract, Load, Transform)](/concepts/etl-elt/elt/)
