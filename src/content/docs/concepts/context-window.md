...
* **Đầu vào + Đầu ra = Tổng dung lượng**: Giới hạn của cửa sổ ngữ cảnh bao gồm cả phần câu hỏi của người dùng `(prompt)`, tài liệu đính kèm thêm (ví dụ qua RAG) và cả câu trả lời mà AI sẽ viết ra. Nếu prompt đầu vào của bạn đã chiếm tới 99% giới hạn, mô hình sẽ chỉ còn 1% không gian để viết câu trả lời.
...
* **System prompt (chỉ thị hệ thống)**: 100 tokens.
