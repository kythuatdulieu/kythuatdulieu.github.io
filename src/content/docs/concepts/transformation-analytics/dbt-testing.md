...
1. **[Data Quality](/concepts/data-quality/data-quality/)** - Hiểu về triết lý quản trị chất lượng dữ liệu.
2. **[dbt Models - Tầng biến đổi và cấu trúc dự án](/concepts/transformation-analytics/dbt-models/)** - Cách phân tầng thư mục dbt khoa học.
3. **dbt Labs Documentation** - Tài liệu hướng dẫn chính thức từ hãng dbt về các phương thức testing.
