...
definition: "Top-p (Nucleus Sampling) là kỹ thuật giải mã giới hạn nhóm token tiềm năng được chọn bằng cách tích lũy xác suất từ cao xuống thấp cho đến khi đạt ngưỡng p mong muốn."
---
...
### Điểm mạnh (Pros)
* **Linh hoạt theo ngữ cảnh:** Khác với Top-k cố định, Top-p tự động điều chỉnh số lượng token được lấy mẫu tùy thuộc vào mức độ tự tin của mô hình.
* **Cân bằng tốt:** Giúp cân bằng hoàn hảo giữa tính sáng tạo và sự logic của văn bản sinh ra.

### Điểm yếu (Cons)
* **Chi phí tính toán:** Đòi hỏi thêm bước sắp xếp và tính toán tổng tích lũy xác suất trên toàn bộ từ điển sau khi chạy lớp Softmax, tạo ra một overhead nhỏ.

## Khi nào nên dùng

### Nên dùng:
* **Top-p thấp (\\$0.1 - 0.3$):** Phù hợp khi thực hiện các tác vụ cần độ chính xác cao, đòi hỏi tư duy logic như lập trình, dịch thuật kỹ thuật, trích xuất dữ liệu có cấu trúc.
* **Top-p cao (\\$0.7 - 0.95$):** Phù hợp cho các bài toán sáng tạo nội dung, tiếp thị, viết kịch bản hoặc hội thoại tự nhiên với người dùng.

### Không nên dùng:
* Không nên thay đổi Top-p đồng thời cùng với Temperature vì điều này khiến đầu ra của mô hình trở nên bất ổn và khó kiểm soát.

## Khái niệm liên quan & Tài liệu tham khảo

**Khái niệm liên quan:**
* [Nhiệt độ (Temperature)](/concepts/6-ai-ml/genai-ml/temperature/)
