...
# Khả năng quan sát dữ liệu (Data Observability): Chăm sóc sức khỏe cho dòng chảy dữ liệu
...
* [Metadata Management (Quản lý siêu dữ liệu)](/concepts/metadata-management) - Cách thức quản lý thông tin về dữ liệu trong hệ thống.
* [Data Lineage (Phả hệ dữ liệu)](/concepts/data-lineage) - Bản đồ mô tả dòng chảy và nguồn gốc của dữ liệu.
