...
1. **[dbt Testing](/concepts/dbt-testing)** - Tìm hiểu cách dbt xử lý kiểm thử dữ liệu bằng SQL.
2. **[Data Quality](/concepts/data-quality)** - Hiểu về triết lý quản trị chất lượng dữ liệu.
