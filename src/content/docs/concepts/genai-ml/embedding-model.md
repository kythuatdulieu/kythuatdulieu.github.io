...
* **Ưu điểm**: Có thể tính toán trước và lưu trữ vectơ tĩnh. Tốc độ truy vấn trên Vector DB cực kỳ nhanh (milli-giây) trên quy mô hàng triệu bản ghi.
* **Nhược điểm**: Do hai văn bản được xử lý độc lập qua mạng nơ-ron và không thể tương tác trực tiếp với nhau ở bước Attention, mô hình đôi khi bỏ sót các mối liên hệ ngữ nghĩa sâu sắc.

### Kiến trúc Cross-Encoder
* **Ưu điểm**: Độ chính xác vượt trội nhờ cơ chế Attention hai chiều giữa hai văn bản.
* **Nhược điểm**: Chi phí tính toán cực kỳ lớn, không thể lưu trữ trước kết quả, không phù hợp cho tìm kiếm quy mô lớn.
