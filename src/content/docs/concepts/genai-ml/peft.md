...
Trong số các kỹ thuật thuộc họ PEFT, **[LoRA](/concepts/genai-ml/lora/) (Low-Rank Adaptation)** chính là phương pháp nổi tiếng và đang chiếm ưu thế tuyệt đối nhờ tính hiệu quả vượt trội.
...
* **Mục đích của người phỏng vấn**: Kiểm tra kinh nghiệm thiết kế kiến trúc hệ thống phục vụ mô hình ([Model Serving](/concepts/genai-ml/model-serving/)) trong môi trường production.
