...
* **Gợi ý trả lời**: SFT dạy mô hình bắt chước các câu chữ mẫu ở cấp độ từng từ ([token](/concepts/genai-ml/token/)-level) dựa trên hàm mất mát Cross-Entropy. Điều này khiến mô hình bị giới hạn bởi lượng dữ liệu mẫu có hạn và dễ gặp hiện tượng lệch phân phối (distribution shift) - tức là nếu mô hình viết sai một từ ở đầu câu, các từ sau sẽ bị sai hàng loạt. 
