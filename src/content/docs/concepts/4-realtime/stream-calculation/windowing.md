...
definition: "Windowing (Phân nhóm theo cửa sổ) là kỹ thuật chia cắt luồng dữ liệu vô hạn thành các khối dữ liệu thời gian hữu hạn để thực hiện các phép toán thống kê và tổng hợp."
---
...
![Sơ đồ minh họa kiến trúc Windowing](/images/windowing/diagram_1.svg)
...
![Quy trình xử lý và luồng dữ liệu Windowing](/images/windowing/diagram_2.svg)
...
* [Stream-Table Duality](/concepts/4-realtime/streaming-processing/stream-table-duality/)
...
1. [Apache Flink Documentation - Windows](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream/operators/windows/) - Apache Flink Documentation
2. [Kafka Streams Documentation - Windowing Data](https://docs.confluent.io/platform/current/streams/developer-guide/dsl-api.html#windowing) - Confluent Docs
3. [Google Cloud Dataflow: Windowing Concepts](https://cloud.google.com/dataflow/docs/concepts/streaming-pipelines) - Google Cloud Docs
4. [AWS MSK Windowing Best Practices](https://docs.aws.amazon.com/msk/latest/developerguide/best-practices.html) - Amazon Web Services
5. [Azure Stream Analytics Windowing Functions](https://learn.microsoft.com/en-us/azure/stream-analytics/stream-analytics-window-functions) - Microsoft Learn
