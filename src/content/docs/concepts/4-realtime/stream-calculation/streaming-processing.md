...
definition: "Streaming Processing (Xử lý dòng dữ liệu) là phương pháp tính toán và xử lý dữ liệu liên tục dưới dạng luồng sự kiện vô hạn ngay khi chúng phát sinh theo thời gian thực."
---
...
* [Batch Processing - Xử lý theo lô](/concepts/3-integration/batch-processing/batch-processing/)
...
1. [Apache Kafka Introduction to Event Streaming](https://kafka.apache.org/documentation/#intro_concepts_and_terms) - Apache Software Foundation
2. [Confluent Event Streaming Platform Guide](https://docs.confluent.io/platform/current/platform-doc.html) - Confluent Docs
3. [Google Cloud Dataflow: Stream Processing Concepts](https://cloud.google.com/dataflow/docs/concepts/streaming-pipelines) - Google Cloud Docs
4. [AWS MSK Introduction to Streaming Pipelines](https://docs.aws.amazon.com/msk/latest/developerguide/what-is-msk.html) - Amazon Web Services
5. [Azure Stream Analytics Real-Time Processing Guide](https://learn.microsoft.com/en-us/azure/stream-analytics/stream-analytics-introduction) - Microsoft Learn
...
7. [Designing Data-Intensive Applications](https://www.oreilly.com/library/view/designing-data-intensive-applications/9781491903063/) - Martin Kleppmann
