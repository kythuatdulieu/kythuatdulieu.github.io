...
![Sơ đồ minh họa kiến trúc Exactly Once Semantics](/images/exactly-once-semantics/diagram_1.svg)
...
![Quy trình xử lý và luồng dữ liệu Exactly Once Semantics](/images/exactly-once-semantics/diagram_2.svg)
