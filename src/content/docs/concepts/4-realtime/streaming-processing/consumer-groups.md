...
metaDescription: "Khám phá Consumer Groups trong Apache Kafka: Cách kết hợp nhiều ứng dụng để chia sẻ tải tiêu thụ dữ liệu song song và cơ chế Rebalance khi gặp lỗi."
definition: "Consumer Group trong Apache Kafka là cơ chế nhóm nhiều tiến trình tiêu thụ dữ liệu (Consumers) để chia sẻ tải và đọc song song các phân vùng (Partitions) của một Topic mà không bị trùng lặp dữ liệu."
---
...
1. [Apache Kafka Consumer Group Design](https://kafka.apache.org/documentation/#consumerconfigs) - Apache Software Foundation
2. [Confluent Consumer Group Concepts](https://docs.confluent.io/platform/current/clients/consumer.html) - Confluent Docs
3. [AWS MSK Consumer Scaling Best Practices](https://docs.aws.amazon.com/msk/latest/developerguide/best-practices.html) - Amazon Web Services
4. [Azure Event Hubs Kafka Consumer Guide](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-for-kafka-ecosystem-overview) - Microsoft Learn
5. [Google Cloud Pub/Sub and Kafka Architecture](https://cloud.google.com/pubsub/docs/comparing-pubsub-kafka) - Google Cloud Docs
