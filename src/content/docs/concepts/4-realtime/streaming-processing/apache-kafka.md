...
definition: "Apache Kafka là nền tảng phân phối luồng sự kiện phân tán (Distributed Event Streaming) mã nguồn mở, hoạt động theo mô hình xuất bản/đăng ký (Publish/Subscribe) và lưu trữ log nối tiếp (append-only log), giúp trung chuyển dữ liệu thời gian thực với độ trễ siêu thấp."
---
...
![Sơ đồ minh họa kiến trúc Apache Kafka](/images/apache-kafka/diagram_1.png)
...
![Quy trình xử lý và luồng dữ liệu Apache Kafka](/images/apache-kafka/diagram_2.png)
...
Cùng lúc đó, nhiều nhóm phát triển khác nhau có thể tự viết các script Consumer riêng biệt đăng ký vào topic `purchases` để cùng đọc và xử lý bản ghi giao dịch của Bob theo nhu cầu riêng (ví dụ: team phân tích nạp vào [Data Lake](/concepts/2-storage/data-lake-lakehouse/data-lake/), team bảo mật kiểm tra gian lận, team chăm sóc khách hàng gửi email cảm ơn).
...
* Làm cổng thu thập dữ liệu ([Data Ingestion](/concepts/3-integration/etl-elt/data-ingestion/)) khổng lồ từ các nguồn log, ứng dụng Web/App để đổ về Data Lake.
...
* [Streaming Processing](/concepts/4-realtime/streaming-processing/streaming-processing/)
...
1. [Apache Kafka Documentation](https://kafka.apache.org/documentation/) - Apache Software Foundation
2. [Confluent Apache Kafka Developer Guide](https://docs.confluent.io/platform/current/platform-doc.html) - Confluent Docs
3. [AWS MSK Developer Guide](https://docs.aws.amazon.com/msk/latest/developerguide/what-is-msk.html) - Amazon Web Services
4. [Azure Event Hubs for Kafka](https://learn.microsoft.com/en-us/azure/event-hubs/event-hubs-for-kafka-ecosystem-overview) - Microsoft Learn
5. [Google Cloud Pub/Sub and Kafka Comparison](https://cloud.google.com/pubsub/docs/comparing-pubsub-kafka) - Google Cloud Docs
