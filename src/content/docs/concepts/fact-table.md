...
* [Dimension Table](/concepts/dimension-table) - Bảng chiều mô tả ngữ cảnh.
* [Star Schema](/concepts/star-schema) - Mô hình hình sao trong thiết kế DWH.
* [Grain](/concepts/grain) - Độ mịn dữ liệu trong thiết kế Fact Table.
