...
1. **[Delta Lake](/concepts/delta-lake)** - Tìm hiểu chi tiết về công nghệ lưu trữ cốt lõi Delta Lake.
2. **[Lệch dữ liệu - Data Skew](/concepts/data-skew)** - Cách nhận diện và khắc phục lỗi lệch dữ liệu trong Spark.
