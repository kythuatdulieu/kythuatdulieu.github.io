...
**Khái niệm liên quan:**
* [Large Language Model (LLM) - Mô hình ngôn ngữ lớn](/concepts/llm)
* [Zero-shot Learning - Học không ví dụ](/concepts/zero-shot)
* [Few-shot Prompting - Học qua vài ví dụ](/concepts/few-shot)
* [Hallucination - Ảo giác LLM](/concepts/hallucination)
