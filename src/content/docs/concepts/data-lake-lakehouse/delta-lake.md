...
### 1. Khởi tạo và ghi dữ liệu thô```python
...
Khi có dữ liệu khách hàng mới (Alice đổi tuổi thành 26, Charlie là khách hàng mới đăng ký):```python
...
Lỡ tay chạy nhầm câu lệnh xóa hay làm hỏng dữ liệu? Khôi phục lại phiên bản ban đầu chỉ với 1 câu lệnh:```sql
