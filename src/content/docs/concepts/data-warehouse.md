...
1. **[Dimensional Modeling](/concepts/dimensional-modeling)** - Thiết kế mô hình dữ liệu cho Data Warehouse.
2. **[Slowly Changing Dimension (SCD)](/concepts/slowly-changing-dimension)** - Các kỹ thuật quản lý thay đổi thuộc tính dimension.
