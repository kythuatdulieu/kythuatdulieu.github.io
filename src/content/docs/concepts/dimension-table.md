...
1. **[Fact Table](/concepts/fact-table)** - Tìm hiểu về bảng sự kiện trong Data Warehouse.
2. **[Slowly Changing Dimension (SCD)](/concepts/slowly-changing-dimension)** - Các kỹ thuật quản lý lịch sử thay đổi của bảng chiều.
