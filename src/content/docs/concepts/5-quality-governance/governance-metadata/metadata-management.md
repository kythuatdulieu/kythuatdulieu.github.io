...
![../_images/schema-registry-ecosystem.jpg](/images/metadata-management/diagram_1.jpg)

![Microsoft](/images/metadata-management/diagram_2.png)
...
3. **Operational Metadata (Siêu dữ liệu vận hành)**: Mô tả trạng thái hoạt động của hệ thống và các đường ống dẫn dữ liệu (data pipelines).
   * *Ví dụ*: Đường ống [ETL](/concepts/3-integration/etl-elt/etl/) vừa hoàn thành lúc 2:00 AM, chạy mất 15 phút, đã chèn thêm 10.000 dòng dữ liệu mới và không phát hiện lỗi nào.
...
1. **Tự động thu thập (Ingestion)**: Các bộ quét (crawlers) của hệ thống quản lý metadata (như DataHub, OpenMetadata) sẽ tự động kết nối qua API tới [Data Warehouse](/concepts/2-storage/data-warehouse/data-warehouse/) và các công cụ lập lịch (Airflow, [dbt](/concepts/3-integration/transformation-analytics/dbt/)) để lấy schema, lịch sử chạy và logs của hệ thống theo chu kỳ ngắn.
...
* [Data Governance](/concepts/5-quality-governance/governance-metadata/data-governance/)
...
5. [Apache Atlas Metadata Guide](https://atlas.apache.org/1.0.0/Atlas-Architecture.html) - Cấu hình và phân tích siêu dữ liệu qua giao diện Apache Atlas.
