...
metaDescription: "Khám phá cách phát hiện bất thường (Anomaly Detection) trong Data Quality bằng thống kê và ML để tự động hóa giám sát và ngăn chặn lỗi dữ liệu."
definition: "Tìm hiểu cách phát hiện bất thường (Anomaly Detection) trong kỹ thuật dữ liệu bằng thuật toán thống kê và học máy để tự động hóa giám sát chất lượng dữ liệu."
---
...
Về bản chất, Anomaly Detection trong [Data Quality](/concepts/5-quality-governance/data-quality/data-quality/) là bài toán **Phân tích chuỗi thời gian (Time-series Forecasting)**:
...
* **Hạn chế (Cons):** Khi hệ thống báo động đỏ, nó chỉ có thể nói cho bạn biết dữ liệu đang có bất thường, chứ không thể giải thích cụ thể *"tại sao"* tỷ lệ NULL hay thể tích dữ liệu lại biến động như vậy. Bạn vẫn phải tự lần theo bản đồ Lineage để debug thủ công. Cảnh báo mang tính phản ứng (Reactive) và chỉ được đưa ra sau khi dữ liệu đã được nạp vào [Data Warehouse](/concepts/2-storage/data-warehouse/data-warehouse/) và mô hình chạy xong.
...
* **[Data Quality](/concepts/5-quality-governance/data-quality/data-quality)**: Khái niệm cốt lõi về chất lượng dữ liệu.
* **[Data Testing](/concepts/5-quality-governance/data-quality/data-testing)**: So sánh kiểm thử tĩnh với kiểm thử động/ML.
* **[Data Profiling](/concepts/5-quality-governance/data-quality/data-profiling)**: Bước đi đầu tiên để hiểu phân phối dữ liệu trước khi cấu hình phát hiện bất thường.
* **[Data Quality Dimensions](/concepts/5-quality-governance/data-quality/data-quality-dimensions)**: Các chiều đo lường chất lượng dữ liệu cơ bản.
* **[Data Reconciliation](/concepts/5-quality-governance/data-quality/data-reconciliation)**: Đối chiếu dữ liệu giữa các nguồn.
* **[Data Observability](/concepts/5-quality-governance/data-quality/observability-sla-slo)**: Bức tranh toàn cảnh về giám sát dữ liệu.

## Trọng tâm ôn luyện phỏng vấn

### Câu 1: Sự khác biệt lớn nhất về mặt triết lý giữa Data Testing và Anomaly Detection là gì?
...
### Câu 2: Thuật toán phân tích chuỗi thời gian thường gặp phải lỗi cảnh báo giả (False Positive) vào các dịp Lễ, Tết hoặc mùa mua sắm. Bạn sẽ xử lý vấn đề này như thế nào?
...
1. [AWS - Anomaly Detection in AWS Glue Data Quality](https://docs.aws.amazon.com/glue/latest/dg/data-quality-anomaly-detection.html)
2. [Google Cloud - Anomaly Detection Overview in BigQuery](https://cloud.google.com/bigquery/docs/anomaly-detection-overview)
3. [Snowflake - Introduction to Data Metric Functions and Anomaly Detection](https://docs.snowflake.com/en/user-guide/data-quality-intro)
4. [Databricks - Lakehouse Monitoring and Data Quality](https://docs.databricks.com/en/lakehouse-monitoring/index.html)
5. [Meta Prophet - Official Documentation for Forecasting Seasonal Time-Series Data](https://facebook.github.io/prophet/docs/quick_start.html)
6. [Netflix Tech Blog - RAD Outlier Detection on Big Data](https://netflixtechblog.com/rad-outlier-detection-on-big-data-d6b0494371cc)
