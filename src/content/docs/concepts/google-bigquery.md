...
# Google BigQuery: Nền tảng phân tích dữ liệu quy mô siêu lớn không máy chủ (Serverless)
...
* [Serverless Data Processing (Xử lý dữ liệu không máy chủ)](/concepts/serverless-data)
