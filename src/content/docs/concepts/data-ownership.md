...
# Quyền sở hữu dữ liệu (Data Ownership): Phân định trách nhiệm rõ ràng trong doanh nghiệp
...
* [Data Governance (Quản trị dữ liệu)](/concepts/data-governance) - Khung quản trị đảm bảo dữ liệu nhất quán và bảo mật.
* [Data Catalog (Danh mục dữ liệu)](/concepts/data-catalog) - Hệ thống quản lý siêu dữ liệu và tìm kiếm tài sản dữ liệu.
* **DAMA-DMBOK (Data Management Body of Knowledge)** - Chương viết về Data Governance và Data Stewardship.
* **Data Mesh: Delivering Data-Driven Value at Scale** - Zhamak Dehghani (Tác giả sáng lập mô hình Data Mesh).
