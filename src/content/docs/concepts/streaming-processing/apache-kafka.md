...
* Làm cổng thu thập dữ liệu ([Data Ingestion](/concepts/etl-elt/data-ingestion/)) khổng lồ từ các nguồn log, ứng dụng Web/App để đổ về Data Lake.
...
* [Streaming Processing](/concepts/streaming-processing/streaming-processing/)
* [Kafka Topics & Partitions](/concepts/streaming-processing/kafka-topics-partitions/)
* [Consumer Groups](/concepts/streaming-processing/consumer-groups/)
...
2. [Confluent Resources & Blog](https://www.confluent.io/resources/)
