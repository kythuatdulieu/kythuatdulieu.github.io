...
### 2.1. [Beginner Data Engineer](/learning-paths/core-paths/beginner-de/)
...
### 2.2. [Junior to Middle Data Engineer](/learning-paths/core-paths/junior-to-middle-de/)
...
### 2.3. [Middle to Senior Data Engineer](/learning-paths/core-paths/middle-to-senior-de/)
...
### 3.1. [Data Platform Engineer (Data SRE)](/learning-paths/specializations/data-platform-engineer/)
...
### 3.2. [Analytics Engineer](/learning-paths/specializations/analytics-engineer/)
...
### 3.3. [Streaming Data Engineer](/learning-paths/specializations/streaming-data-engineer/)
...
### 3.4. [Cloud Data Engineer / Architect](/learning-paths/specializations/cloud-data-engineer/)
...
- **[Khám phá chi tiết: Lộ trình Chuẩn bị Phỏng Vấn (Interview Prep)](/learning-paths/interview-prep/)**
...
> Hãy bắt đầu với con đường [Beginner Data Engineer](/learning-paths/core-paths/beginner-de/) nếu bạn là người mới, và kiên nhẫn xây dựng từng khối kiến thức (building blocks). Data Engineering là một cuộc chạy marathon, không phải một cuộc chạy nước rút. Đừng cố gắng học mọi công cụ cùng một lúc (Shiny Object Syndrome), hãy tập trung thấu hiểu **nguyên lý cốt lõi** đằng sau chúng!