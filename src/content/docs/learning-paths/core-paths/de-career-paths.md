...
tags: ["career", "junior", "senior", "staff", "architect", "learning-path"]
readingTime: "10 mins"
lastUpdated: 2026-07-11
seoTitle: "Nấc thang sự nghiệp của Data Engineer"
metaDescription: "Các nhánh phát triển nghề nghiệp của Data Engineer: Junior, Middle, Senior, Staff, Architect, Analytics Engineer, Platform Engineer và Manager."
...
flowchart LR
    ...
    S --> ST["Staff / Principal (IC track)"]
    S --> AR["Data Architect"]
    S --> MG["Engineering Manager"]
    M --> AE["Analytics Engineer"]
    M --> PE["Data Platform Engineer"]
    ST <-.có thể qua lại.-> MG
```

Một cách kiểm tra cấp độ thực tế hơn mọi bảng mô tả: cùng một sự cố “dashboard doanh thu sáng nay thiếu số”, mỗi cấp phản ứng khác nhau.

- Junior: kiểm tra job có fail không và rerun.
- Middle: truy ngược lineage tìm task lỗi, rerun đúng partition, viết thêm test để lần sau bắt sớm.
- Senior: hỏi vì sao lớp reconciliation không cảnh báo trước người dùng, sửa cả cơ chế phát hiện.
- Staff: nhận ra nhiều team từng gặp lỗi dạng này, chuẩn hóa một khung [data observability](/concepts/7-dataops-orchestration-quality/data-observability/) dùng chung.
- Manager: đảm bảo sự cố có [post-mortem](/learning-paths/leadership-culture/post-mortems-culture/) không đổ lỗi và việc sửa gốc được ưu tiên trong sprint.
